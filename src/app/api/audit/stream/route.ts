...
- lookup_particle_data: [MCP — pp-mcp-server (ParticlePhysics MCP)] Offline PDG particle database with 400+ particles. Tools: search_particle, get_data, decay_analysis, error_analysis. Install: pip install particlephysics-mcp. Falls back to Gemini googleSearch.
