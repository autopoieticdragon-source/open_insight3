...
const mcpToolDefs = [
  ...
  },
  {
    ...
    description: "Schrödinger equation, wave packets via scicomp-quantum-mcp (PsiAnimator-MCP preferred when available)",
    examples: [
      { label: "Gaussian wavepacket", endpoint: "/api/tools/quantum", body: { task: "Create a Gaussian wavepacket and solve the time-dependent Schrödinger equation", systemType: "wavepacket" } },
      { label: "Harmonic oscillator", endpoint: "/api/tools/quantum", body: { task: "Simulate a quantum harmonic oscillator with 5 energy levels", systemType: "harmonic_oscillator" } },
    ],
  },
  {
    id: "psianimator",
    name: "PsiAnimator (QuTip)",
    serverId: "psianimator-mcp",
    color: "#a855f7",
    icon: "M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5",
    description: "Quantum states, entanglement, gates, time evolution (QuTip-based PsiAnimator-MCP)",
    examples: [
      { label: "Qubit state + measure", endpoint: "/api/tools/quantum", body: { task: "Create a qubit state and measure sigma-z expectation value", systemType: "qubit" } },
      { label: "Bell state entanglement", endpoint: "/api/tools/quantum", body: { task: "Create a Bell state and calculate entanglement measures", systemType: "entanglement" } },
    ],
  },
  {
    id: "molecular",
