            ...
            <div className="absolute left-0 top-full mt-2 w-80 glass-card shadow-2xl overflow-hidden z-50 max-h-[calc(100vh-80px)] overflow-y-auto">
              ...
              <div className="py-1">
                {[
                  ...
                  { label: "Autonomous Agents", href: "/audit", desc: "AI agents autonomously exploring the platform", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
                ].map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
